...
test.describe('Form Layouts page', () => {
	...
	test('Input fields', async ({page}, testInfo) => {
		if(testInfo.retry) {
			// Do something (for example, clean up database before retry)
		}
...
test('web tables', async ({page}) => {
	...
	// Scenario 1 - get the row by any test in this row
	...
	// Scenario 2 - get the row based on the value in the specific column
...
test('datepicker', async ({page}) => {
	...
	const dateToAssert = `${expectedMonthShort} ${expectedDate}, ${expectYear}`
